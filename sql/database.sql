...
-- Shared hosting (x10, cPanel) bilan to'liq mos
-- =========================================================

-- (CREATE DATABASE / USE — install.php tomonidan boshqariladi)
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `last_warned_at`    DATETIME DEFAULT NULL,
  `created_at`        TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  `updated_at`        TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  UNIQUE KEY `uk_email` (`email`),
  UNIQUE KEY `uk_phone` (`phone`),
  UNIQUE KEY `uk_referral` (`referral_code`),
  KEY `idx_role` (`role`),
...
CREATE TABLE IF NOT EXISTS `questions` (
  ...
  KEY `idx_ticket_status` (`ticket_id`,`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Demo akkauntlar (parol: admin123 / dev123 / user123 - install.php yangisini yaratadi)
INSERT IGNORE INTO `users` (id, first_name, last_name, email, phone, password, role, status, referral_code) VALUES
(1, 'Admin', 'VatanParvar', 'admin@vatanparvar.uz', '998901234567', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', 'active', 'ADMIN001'),
(2, 'Developer', 'VatanParvar', 'dev@vatanparvar.uz', '998901234568', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'developer', 'active', 'DEV0001'),
(3, 'Test', 'User', 'user@vatanparvar.uz', '998901234569', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'user', 'active', 'USER001');

-- Tariflar
INSERT IGNORE INTO `tariffs` (id, name_latin, name_cyrillic, description_latin, description_cyrillic, price, duration_days, features_latin, features_cyrillic, tests_per_day, is_popular, sort_order) VALUES
(1, 'Bepul', 'Бепул', 'Boshlang''ich foydalanuvchilar uchun', 'Бошланғич фойдаланувчилар учун', 0, 30, 'Kunlik 3 ta test|Asosiy savollar|Statistika', 'Кунлик 3 та тест|Асосий саволлар|Статистика', 3, 0, 1),
(2, 'Standart', 'Стандарт', 'Faol o''quvchilar uchun', 'Фаол ўқувчилар учун', 49000, 30, 'Cheksiz testlar|Barcha biletlar|Batafsil statistika|Reyting', 'Чексиз тестлар|Барча билетлар|Батафсил статистика|Рейтинг', 999, 1, 2),
(3, 'Premium', 'Премиум', 'Eng yaxshi tayyorlanish uchun', 'Энг яхши тайёрланиш учун', 99000, 30, 'Cheksiz testlar|Barcha biletlar|Video darslar|Shaxsiy mentor|Sertifikat', 'Чексиз тестлар|Барча билетлар|Видео дарслар|Шахсий ментор|Сертификат', 999, 0, 3);
...
('site_logo', '/assets/images/logo.svg', 'image', 'general'),
('site_banner', '/assets/images/banner.svg', 'image', 'general'),
...
-- Biletlar
INSERT IGNORE INTO `tickets` (id, title_latin, title_cyrillic, ticket_number, questions_count, time_minutes) VALUES
(1, 'Bilet 1', 'Билет 1', 1, 20, 25),
(2, 'Bilet 2', 'Билет 2', 2, 20, 25),
(3, 'Bilet 3', 'Билет 3', 3, 20, 25),
(4, 'Bilet 4', 'Билет 4', 4, 20, 25),
(5, 'Bilet 5', 'Билет 5', 5, 20, 25);

-- Namuna savollar
INSERT IGNORE INTO `questions` (id, ticket_id, question_latin, question_cyrillic, category, difficulty) VALUES
(1, 1, 'Yo''l harakati nima?', 'Йўл ҳаракати нима?', 'Asoslar', 'easy'),
(2, 1, 'Svetoforning sariq rangi nimani anglatadi?', 'Светофорнинг сариқ ранги нимани англатади?', 'Belgilar', 'easy'),
(3, 1, 'Eng yuqori tezlik shaharda qancha?', 'Энг юқори тезлик шаҳарда қанча?', 'Tezlik', 'medium');

-- Namuna javoblar
INSERT IGNORE INTO `answers` (question_id, answer_latin, answer_cyrillic, is_correct, sort_order) VALUES
(1, 'Avtomobillarning yurishi', 'Автомобилларнинг юриши', 0, 1),
(1, 'Yo''lda transport va piyodalarning harakati', 'Йўлда транспорт ва пиёдаларнинг ҳаракати', 1, 2),
(1, 'Faqat piyodalarning yurishi', 'Фақат пиёдаларнинг юриши', 0, 3),
(1, 'Faqat avtobus harakati', 'Фақат автобус ҳаракати', 0, 4),
(2, 'To''xtang', 'Тўхтанг', 0, 1),
(2, 'Diqqat, tayyorlaning', 'Диққат, тайёрланинг', 1, 2),
(2, 'Yuring', 'Юринг', 0, 3),
(2, 'Orqaga qayting', 'Орқага қайтинг', 0, 4),
(3, '40 km/soat', '40 км/соат', 0, 1),
(3, '60 km/soat', '60 км/соат', 1, 2),
(3, '80 km/soat', '80 км/соат', 0, 3),
(3, '90 km/soat', '90 км/соат', 0, 4);

-- Namuna bloglar
INSERT IGNORE INTO `blog_posts` (title_latin, title_cyrillic, slug, excerpt_latin, excerpt_cyrillic, content_latin, content_cyrillic, category, status) VALUES
...
-- Namuna sharhlar
INSERT IGNORE INTO `reviews` (name, text, rating, status) VALUES
